...
public class sign_in extends AppCompatActivity {
    ...
    public void sign_in(View view) {
        ...
        if (r == false) {
            Toast.makeText(this, "Invaild data! Try again", Toast.LENGTH_LONG).show();
            email_user.getText().clear();
            password_user.getText().clear();
        }
        else
        {
            Toast.makeText(this, "Login Successfully! Welcome " + user_info.user_name, Toast.LENGTH_LONG).show();
            email_user.getText().clear();
            password_user.getText().clear();
